...
const schedules = [
  { patient: "Andi Pratama", session: "Pagi",  machine: "HD-01", start: "07:00", end: "11:00", status: "Selesai",     note: "-" },
  { patient: "Budi Santoso", session: "Pagi",  machine: "HD-02", start: "07:00", end: "11:00", status: "Berlangsung", note: "Monitoring rutin" },
  { patient: "Citra Lestari", session: "Pagi",  machine: "HD-04", start: "07:00", end: "11:00", status: "Terlambat",  note: "Datang 25 menit terlambat" },
  { patient: "Dewi Anggraini", session: "Pagi",  machine: "HD-05", start: "07:00", end: "11:00", status: "Selesai",     note: "-" },
  { patient: "Eko Saputra", session: "Pagi",  machine: "HD-06", start: "07:00", end: "11:00", status: "Menunggu",    note: "Menunggu asesmen pra-HD" },
  { patient: "Fajar Ramadhan", session: "Pagi",  machine: "HD-03", start: "07:00", end: "11:00", status: "Batal",       note: "Mesin maintenance" },
  { patient: "Gita Maharani", session: "Pagi",  machine: "HD-01", start: "07:00", end: "11:00", status: "Terjadwal",   note: "Contoh konflik jadwal mesin" },
  { patient: "Hadi Wijaya", session: "Pagi",  machine: "HD-02", start: "07:00", end: "11:00", status: "Terjadwal",   note: "Contoh konflik jadwal mesin" },

  { patient: "Indah Permata", session: "Siang", machine: "HD-01", start: "12:00", end: "16:00", status: "Terjadwal",   note: "-" },
  { patient: "Joko Susanto", session: "Siang", machine: "HD-02", start: "12:00", end: "16:00", status: "Terjadwal",   note: "-" },
  { patient: "Kiki Amelia", session: "Siang", machine: "HD-03", start: "13:00", end: "17:00", status: "Terjadwal",   note: "Setelah maintenance selesai" },
  { patient: "Lina Marlina", session: "Siang", machine: "HD-04", start: "12:00", end: "16:00", status: "Menunggu",    note: "-" },
  { patient: "Maya Sari", session: "Siang", machine: "HD-05", start: "12:00", end: "16:00", status: "Terjadwal",   note: "-" },
  { patient: "Nanda Putri", session: "Siang", machine: "HD-06", start: "12:00", end: "16:00", status: "Terjadwal",   note: "-" },
  { patient: "Oki Pratama", session: "Siang", machine: "HD-01", start: "12:00", end: "16:00", status: "Batal",       note: "Konfirmasi pembatalan pasien" },
  { patient: "Putri Ayu", session: "Siang", machine: "HD-05", start: "12:00", end: "16:00", status: "Terlambat",  note: "Belum hadir sesuai jadwal" }
];
